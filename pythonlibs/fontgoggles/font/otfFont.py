...
class OTFFont(_OTFBaseFont):
    ...
    def load(self, outputWriter):
        # print("ADL WARNING -- Currently using a modified version of OTFFont.load (original was async)")
...
class TTXFont(_OTFBaseFont):
    ...
    def load(self, outputWriter):
        # print("ADL WARNING -- Currently using a modified version of TTXFont.load (original was async)")
